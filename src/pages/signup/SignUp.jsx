				...
				<form onSubmit={handleSubmit}>
					<div>
						...
						<input
							...
							className='w-full input bg-gray-700 input-bordered  h-10 text-white'
					...
					<div>
						...
						<input
							...
							className='w-full bg-gray-700 input input-bordered h-10 text-white'
					...
					<Link
						to={"/login"}
						className='text-white hover:underline hover:text-blue-600 mt-2 inline-block'
						href='#'
					>
